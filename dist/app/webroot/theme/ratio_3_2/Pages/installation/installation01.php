...
<h2>「default」で使用されている画像を読み込む</h2>

<p>「default」にはメイン画像・ブログ記事のアイキャッチ画像・解説用の画像が含まれていますが、テーマ設定から読み込むことはできません。</p>

<p>「default」の内容を全て確認したい場合は、テーマ内の「files」フォルダに含まれている、「blog」「theme_configs」「uploads」ディレクトリを、下記ディレクトリにコピーしてください。</p>

<p><strong>[baserCMSを設置したディレクトリ]app/webroot/files</strong></p>

<p>同名のフォルダがある場合は、念のためダウンロードするなどで、バックアップを取ってください。</p>